...
<body>
    ...
    <div class="LT_10">
       <div class="menu_LT_1">
    <p class="Style_10_1">
        <a style="padding-top:20px; color:grey;" href="{{ route('lop10.ltdd')}}"><b>Lý thuyết Toán 10 đầy đủ</b></a>

        <a href="#"><b>Lý thuyết Chương 1: Mệnh đề và tập hợp</b></a>
        <a href="{{ route('lop10.bai1') }}">Lý thuyết Bài 1: Mệnh đề</a>
        <a href="{{ route('lop10.bai2') }}">Lý thuyết Bài 2: Tập hợp và các phép toán trên tập hợp</a>
        <a href="#"><b>Lý thuyết Chương 2: Bất phương trình và hệ bất phương trình bậc nhất hai ẩn </b></a>
        <a href="{{ route('lop10.bai1') }}">Lý thuyết Bài 3: Bất phương trình bậc nhất hai ẩn</a>
        <a href="{{ route('lop10.bai2') }}">Lý thuyết Bài 4: Hệ bất phương trình bậc nhất hai ẩn</a>
         <a href="#"><b>Lý thuyết Chương 3: Hệ thức lượng trong tam giác</b></a>
        <a href="{{ route('lop10.bai1') }}">Lý thuyết Bài 5: Giá trị lượng giác của một góc từ 0⁰ đến 180⁰ </a>
        <a href="{{ route('lop10.bai2') }}">Lý thuyết Bài 6: Hệ thức lượng giác trong tam giác</a>
    </p>
</div>
